...
const Indicators = ({ step }: { step: number }) => {
  ...
  const titles = ["Personal Details", "Medical History", "Nominee"];

  return (
    <div className="flex items-center justify-center mt-4 mb-[20px] mobile:mb-[60px]">
            ...
            <div className="ms-[-5rem] mobile:relative mobile:ms-0">
              <span
                className={`mobile:whitespace-nowrap ${
                  i === steps.length - 1 && "mobile:ms-[-1.5rem]"
                } ${
                  i === 0 || i === steps.length - 1 ? "" : "mobile:ms-[-0.7rem]"
